...
const string identity = "deployment-worker";
const string capability = "production.deployment.execute";
const string environment = "production";
const string resource = "checkout-api";
const string apiKey = "dev-deployment-worker-key";
    ...
    int defaultIntervalSeconds)
{
    ...
    Console.WriteLine(
        $"DeploymentWorker started; interval={intervalSeconds}s; Seneschal={baseUrl}");
