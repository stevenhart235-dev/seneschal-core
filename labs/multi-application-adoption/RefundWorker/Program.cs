...
const string identity = "refund-worker";
const string capability = "payments.refund.create";
const string environment = "production";
const string resource = "merchant-123";
const string apiKey = "dev-refund-worker-key";
    ...
    int defaultIntervalSeconds)
{
    ...
    Console.WriteLine(
        $"RefundWorker started; interval={intervalSeconds}s; Seneschal={baseUrl}");
